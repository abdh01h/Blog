<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ config('app.dircetion') }}">
<head>
    <meta charset="utf-8">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {!! Avatar::create(Auth::user()->name)->setDimension(24)->setFontSize(12)->toSvg() !!}
                                    {{ Auth::user()->name }}
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('article.create') }}">Create Article</a>
                                    <a class="dropdown-item" href="{{ route('article.userArticles', Auth::id()) }}">My Articles</a>
